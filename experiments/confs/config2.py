...
__C.LOAD_TFMODEL = False
# Path to the specific tfmodel
__C.TFMODEL = '/home/blur/Documents/git/tf-faster-rcnn/output/vgg16/train/default/vgg16_faster_rcnn_iter_110600.ckpt'
...
__C.TRAIN.SUMMARY_INTERVAL = 1800000000
...
__C.TRAIN.BBOX_THRESH = 0.01

# Iterations between snapshots
__C.TRAIN.SNAPSHOT_ITERS = 3

# solver.prototxt specifies the snapshot path prefix, this adds an optional
# infix to yield the path: <prefix>[_<infix>]_iters_XYZ.caffemodel
__C.TRAIN.SNAPSHOT_PREFIX = 'exec_three_'
...
__C.TRAIN.RPN_POSITIVE_OVERLAP = 0.01
...
__C.TRAIN.RPN_FG_FRACTION = 0.95
